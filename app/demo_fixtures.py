                ...
                event(
                    ...
                    "2026-02-05T11:30:00Z",
                    {
                        ...
                        "packaging_conversion": {
                            "bulk_bin_count": 1,
                            "clamshell_count": 1050,
                            "master_case_count": 87,
                        },
                    },
                ),
...
# 2026-02-05 harvest was already months stale and live ingest would have
# rejected the entire Load Demo Fixture flow -- the one workflow the fixtures
# exist to make reliable. The mock accepted them happily, which is exactly the
# mock-versus-live drift this repository exists to catch, and the gap widened
# by one day every day.
#
...
# beyond a small future ceiling), and small enough that the whole span sits
# far inside the 90-day window.
...
def demo_fixture_shift(now: datetime | None = None) -> timedelta:
    ...
    the fixtures keep their positions relative to each other as well as
