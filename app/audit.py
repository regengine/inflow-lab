...
def summarize_scenario_audit(
    ...
    for record in records:
        ...
        if warning_payload:
            ...
            # Records, not warnings: "three events have a blocker" is the
            # number an operator triages by, and it is not derivable from
            # the warning totals above.
            if any(warning.severity == "required" for warning in record_warnings):
