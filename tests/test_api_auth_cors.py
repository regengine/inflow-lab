"""CORS, Basic Auth, health metadata and request-logging behaviour.

Moved verbatim out of the 1794-line ``test_api.py`` (see #132). Same tests,
same assertions -- only the file they live in changed.
"""
